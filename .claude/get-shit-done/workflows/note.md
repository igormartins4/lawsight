...
- **Global scope**: `/home/igor/Documentos/code/lawsight/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/igor/Documentos/code/lawsight/.claude/notes/`)
...
2. Glob `/home/igor/Documentos/code/lawsight/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/igor/Documentos/code/lawsight/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/igor/Documentos/code/lawsight/.claude/notes/` — works in any directory
