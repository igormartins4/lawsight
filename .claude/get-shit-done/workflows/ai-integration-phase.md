...
```markdown
Read /home/igor/Documentos/code/lawsight/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/igor/Documentos/code/lawsight/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/igor/Documentos/code/lawsight/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/igor/Documentos/code/lawsight/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/igor/Documentos/code/lawsight/.claude/agents/gsd-eval-planner.md for instructions.
