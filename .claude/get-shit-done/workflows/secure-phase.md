...
```
Agent(
  prompt="Read /home/igor/Documentos/code/lawsight/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/igor/Documentos/code/lawsight/.claude/get-shit-done/templates/SECURITY.md`
