...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/igorsantos/code/lawsight/.claude/.gsd-surface.json`
(sibling to `C:/Users/igorsantos/code/lawsight/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/igorsantos/code/lawsight/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Users/igorsantos/code/lawsight/.claude/skills`).
...
`C:/Users/igorsantos/code/lawsight/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/igorsantos/code/lawsight/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/igorsantos/code/lawsight/.claude/.gsd-surface.json`
Install profile marker: `C:/Users/igorsantos/code/lawsight/.claude/.gsd-profile`
Skill dirs: `C:/Users/igorsantos/code/lawsight/.claude/skills/gsd-*/`
Engine module: `C:/Users/igorsantos/code/lawsight/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/igorsantos/code/lawsight/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
