...
<reference>
@/home/igor/Documentos/code/lawsight/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/igor/Documentos/code/lawsight/.claude/get-shit-done/references/user-profiling.md` to load:
