...
Reference full template: `/home/igor/Documentos/code/lawsight/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/igor/Documentos/code/lawsight/.claude/get-shit-done/templates/state.md`.
