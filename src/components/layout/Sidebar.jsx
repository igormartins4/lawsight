...
import logo from '../../assets/lawsight-logo.jpeg'
      ...
      <div className="p-5 border-b border-navy-600">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="font-semibold text-silver-100 text-sm leading-tight">Lawsight</p>
            <p className="text-silver-300 text-xs truncate">Jurimetria Trabalhista</p>
          </div>
        </div>
      </div>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-150 ${
                isActive
                  ? 'bg-navy-800 text-silver-100 font-medium shadow-sm'
                  : 'text-silver-300 hover:text-silver-100 hover:bg-navy-800/50'
              }`
            }
          >
            {item.icon}
