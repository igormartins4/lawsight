...
```
Agent(
  prompt="Read C:/Users/igorsantos/code/lawsight/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/igorsantos/code/lawsight/.opencode/get-shit-done/templates/SECURITY.md`
