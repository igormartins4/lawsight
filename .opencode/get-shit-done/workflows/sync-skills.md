...
INSTALL_JS_GLOBAL="C:/Users/igorsantos/code/lawsight/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/igorsantos/code/lawsight/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
