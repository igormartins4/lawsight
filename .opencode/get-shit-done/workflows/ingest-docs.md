...
```bash
INIT=$(node "C:/Users/igorsantos/code/lawsight/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/igorsantos/code/lawsight/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
