...
```
Agent(
  prompt="Read C:/Users/igorsantos/code/lawsight/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/igorsantos/code/lawsight/.opencode/get-shit-done/templates/VALIDATION.md`
