...
```bash
INIT=$(node "C:/Users/igorsantos/code/lawsight/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/igorsantos/code/lawsight/.opencode/get-shit-done/templates/spec.md.
